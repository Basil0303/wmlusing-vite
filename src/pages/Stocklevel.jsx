  ...
  const getStockLevel = async () => {
    try {
      ...
      if (response.status === true) {
        ...
        setgetStock(response.data.stock);
        setpagination({
                      ...
                      {getstock?.length ? (
                        <>
                          {getstock?.map((product, index) => (
                                                         console.log(product?.movement_id?.products[0],"producssssssssssssssssssssssssst"),
                            ...
                            <tr key={index}>
                              ...
                              <td>{product?.movement_id?.products[0].quantity}</td>
